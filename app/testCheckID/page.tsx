...
// 이미지 URL 상수들
const imgVector827 = "https://www.figma.com/api/mcp/asset/5083093c-7bc9-47af-948d-e480f4c02f41";
const imgVector828 = "https://www.figma.com/api/mcp/asset/20516fcd-e3f1-4db4-943a-7edb4bbaeb69";
const imgEllipse5406 = "https://www.figma.com/api/mcp/asset/ed5fe5b5-bbdb-4df5-bb15-35cd6d8896ef";
const imgEllipse5405 = "https://www.figma.com/api/mcp/asset/12336528-1a82-4f9c-81be-1064a007dfe8";
const imgEllipse5404 = "https://www.figma.com/api/mcp/asset/355676b6-440f-45a9-9457-6aecaba6037f";
const img = "https://www.figma.com/api/mcp/asset/52c1afcc-6a89-434e-bad6-0b8a00079a03";
const img1 = "https://www.figma.com/api/mcp/asset/337896a8-e911-4651-8401-4e11a1284369";
const imgWeuiBackFilled = "https://www.figma.com/api/mcp/asset/974ee083-ed14-4a73-99be-6e4fa81bcbcb";
const img2 = "https://www.figma.com/api/mcp/asset/3a20f35d-cfb8-4441-a822-27af8a76959c";
const img3 = "https://www.figma.com/api/mcp/asset/dc77be31-fb8c-4c0f-993c-886c58f065bd";
const img4 = "https://www.figma.com/api/mcp/asset/0154b22e-d6e2-421e-951d-d30102d4eba1";
const img5 = "https://www.figma.com/api/mcp/asset/5ce4472e-5b79-4610-9877-3bb9ea39e123";
const img6 = "https://www.figma.com/api/mcp/asset/4c300884-a58b-4280-9a61-37e5672b138c";

export default function TestCheckIDPage() {
  ...
  return (
    <div className="h-[812px] overflow-clip relative w-full max-w-[375px] mx-auto" style={{ backgroundImage: "linear-gradient(236.47860593860838deg, rgba(253, 111, 34, 1) 1.2987%, rgba(254, 135, 57, 1) 66.571%)" }}>
      ...
      <div className="absolute bg-[#f8f6f4] flex flex-col gap-[40px] h-[631px] items-center left-0 pb-[24px] pt-[96px] px-0 rounded-tl-[12px] rounded-tr-[12px] shadow-[0px_-4px_10px_0px_rgba(238,74,8,0.4)] top-[181px] w-[375px]">
        ...
        {/* 아이디 표시 영역 */}
        <div className="h-[428px] relative shrink-0 w-full">
          <div className="absolute flex flex-col gap-[100.5px] items-start left-[16px] pb-[55px] pt-[56.5px] px-0 top-[2px] w-[343px]">
                ...
                <div className="flex flex-col gap-[2px] items-start relative shrink-0 w-full">
                  <div className="flex flex-col gap-[5px] items-start relative shrink-0 w-full">
                    ...
                    <div className="bg-[#eeebe6] border border-[#5f5a58] border-solid flex h-[48px] items-center justify-between p-[12px] relative rounded-[12px] shrink-0 w-full">
                      <p className="font-normal leading-[1.5] relative shrink-0 text-[13px] text-[#1a1918] tracking-[-0.26px]">
                        yum0***@gmail.com
                      </p>
