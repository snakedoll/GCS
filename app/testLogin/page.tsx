...
const imgWeuiBackFilled = "https://www.figma.com/api/mcp/asset/e6fbf73e-eca4-4d91-be73-52fba2a5c3f4";
...
export default function TestLoginPage() {
  ...
  return (
    <div className="h-[812px] overflow-clip relative w-full max-w-[375px] mx-auto" style={{ backgroundImage: "linear-gradient(236.47860593860838deg, rgba(253, 111, 34, 1) 1.2987%, rgba(254, 135, 57, 1) 66.571%)" }}>
      ...
      {/* 로고 */}
      <div className="absolute h-[29.608px] left-1/2 shadow-[0px_4px_4px_0px_rgba(197,54,9,0.3)] top-[89px] translate-x-[-50%] w-[84px]">
